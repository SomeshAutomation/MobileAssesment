...
public class WelcomePageObject extends CommonFunction {
  ...
  @AndroidFindBy(
      xpath =
          "//android.widget.TextView[@text=\"NHL"
              + " Hockey\"]/following-sibling::android.widget.ImageView")
  ...
  public static String FAV_TEAM_LEAGUE_FOLLOW_ICON_XPATH =
      "//android.widget.TextView[@text=\"%s\"]/following-sibling::android.widget.ImageView";
