...
public class HomePageObject extends CommonFunction {
    ...
    public static String FAV_LABEL_IN_HORIZONTAL_VIEW_XPATH = "//*[@resource-id=\"com.fivemobile.thescore:id/horizontal_recycler_view\"]//android.widget.TextView[@text=\"%s\"]";
    ...
    public void selectFavFromHorizontalView(String favName) {
        clickElement(waitForVisibilityBy(By.xpath(String.format(FAV_LABEL_IN_HORIZONTAL_VIEW_XPATH, favName))));
    }
