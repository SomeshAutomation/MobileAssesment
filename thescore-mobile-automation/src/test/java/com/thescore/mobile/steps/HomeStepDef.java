...
public class HomeStepDef {
    ...
    public void userIsOnScreenOf(String title, String type) {
        if (type.equals(TEAM)) {
            Assert.assertEquals(teamPageObject.getTeamPageTitle(), title, "User navigate to correct Team screen with title:");
        } else if (type.equals(LEAGUE)) {
            Assert.assertEquals(leaguePageObject.getPageTitleText(), title, " User navigates to correct League screen with title:");
        } else {
